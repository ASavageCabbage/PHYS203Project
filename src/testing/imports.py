...
import utils.phases, utils.absolute, utils.differential, utils.system, utils.graphics

PACKAGES = [utils.phases, utils.absolute, utils.differential, utils.system, utils.graphics]
